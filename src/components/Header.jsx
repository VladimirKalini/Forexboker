...
export default function Header() {
  ...
  },
  {
    ...
    links: [
      ['/market/calculator.html',      { ru: 'Калькулятор',       en: 'Calculator' }],
      ['/market/valuta.html',          { ru: 'Валюты',            en: 'Currencies' }],
      ['/market/akciy.html',           { ru: 'Акции',             en: 'Stocks' }],
      ['/market/energy.html',          { ru: 'Энергоресурсы/Металлы', en: 'Energy/Metals' }],
      ['/market/indexx.html',          { ru: 'Индексы',           en: 'Indices' }],
      ['/market/pokaza.html',          { ru: 'Показатели Рынка',  en: 'Market Metrics' }],
      ['/market/crypto.html',          { ru: 'Крипта',            en: 'Crypto' }],
    ],
  },
  {
    key: 'about',
